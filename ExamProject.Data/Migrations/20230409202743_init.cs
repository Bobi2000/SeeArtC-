        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comics_Pictures_CoverId",
                        column: x => x.CoverId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikedPictures", x => new { x.PictureId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserLikedPictures_Pictures_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Pictures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLikedPictures_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChapterPictures", x => new { x.ChapterId, x.PictureId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikedPictures_UserId",
                table: "UserLikedPictures",
                column: "UserId");
        }
